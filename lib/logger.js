    ...
    if (logConsole) {
        if (config.logging.console.colors) {
            if (system === 'daemon' || system === 'childDaemon') {
                console.log(severityMap[severity](time) + clc.greenBright.bold(' [' + system + '] ' + formattedMessage));
            } else if (system === 'pool' && formattedMessage.toLowerCase().includes('accepted')) {
                console.log(severityMap[severity](time) + clc.blueBright.bold.italic(' [' + system + '] ' + formattedMessage));
            } else if (formattedMessage.toLowerCase().includes('block') && formattedMessage.toLowerCase().includes('found')){
                console.log(severityMap[severity](time) + clc.magentaBright.bold.italic(' [' + system + '}] ' + formattedMessage));
            }else {
